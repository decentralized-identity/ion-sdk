...
import DidKey from '../../dist/lib/DidKey.js';
 ...
 * @returns {KeyPair}
 */
export async function generateKeyPair(type = 'ES256K') {
 /**
...
// 'secp256k1': DidKey.generateEs256kOperationKeyPair,
  ...
  const keyGeneratorFn = DidKey.generateEs256kOperationKeyPair;
  ...
  const [publicJwk, privateJwk] = await DidKey.generateEs256kperationKeyPair();
// keyGeneratorFn();

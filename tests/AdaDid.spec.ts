import jwkEs256k1Public from './vectors/inputs/jwkEs256k1Public.json';
import jwkEs256k2Public from './vectors/inputs/jwkEs256k2Public.json';
import publicKeyModel1 from './vectors/inputs/publicKeyModel1.json';
import service1 from './vectors/inputs/service1.json';
...
describe('AdaDid', async () => {
  ...
  describe('createLongFormDid()', async () => {
    it('vector test - should create a long-form DID correctly.', async () => {
      ...
      // console.log(`recovery key: ${JSON.stringify(recoveryKey)} \n update key: ${JSON.stringify(updateKey)} document:  ${JSON.stringify(document)}`);

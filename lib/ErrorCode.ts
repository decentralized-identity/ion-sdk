...
export default {
  ...
  IonDidEs256kJwkMissingOrInvalidTypeX: 'IonDidEs256kJwkMissingOrInvalidTypeX',
  IonDidEs256kJwkMissingOrInvalidTypeY: 'IonDidEs256kJwkMissingOrInvalidTypeY',
  IonDidServiceEndpointNotValidUrl: 'IonDidServiceEndpointNotValidUrl',
  IonDidServiceEndpointTooLong: 'IonDidServiceEndpointTooLong',
